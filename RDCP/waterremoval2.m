...
dark = waterchannelC(im, patch_size,A);
...
%blurF = wBlurEstimation(rgb2gray(dehazedwb));
%contrastF = imgContrast(dehazedwb);
%noiseF = wNoise(rgb2gray(dehazedwb));
%edgeF = wEdgePreserv(grayIm,rgb2gray(dehazedwb),0);  
  
'Aqui9'
% perform histogram adjustment before showing the image
adjusted = applycform(dehazedwb, makecform('srgb2lab'));
